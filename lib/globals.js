 ...
 * pathToFileURL, not a hand-built "file://" string: that left a "#" in the path
 * to be read as a URL fragment, and a "%" as the start of an escape.
 */
export const gameModuleUrl = (targetPath, relative) => pathToFileURL(path.join(targetPath, relative)).href;
