...
// unit deploy, rollback — and fingerprints the user's real save directory before
// and after. If a single byte, size or mtime moves, it fails.
//
// A test server pointed at the real data directory has destroyed a player's
// rollback snapshots before. This is the test to point at if that fear ever
// comes back.
