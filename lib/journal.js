...
//
// I hit session and weekly limits, and when that happens this process is killed
// without warning. So nothing is held in memory waiting for a tidy ending: every
